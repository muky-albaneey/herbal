...
import { ImLocation } from "react-icons/im"; 
import logo from '../../assets/logo.png';
import SearchResultsDisplay from './SearchResultsDisplay'; // Import the new component
      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div className="mt-6">
          ...
          {searchResults.length > 0 ? (
            <SearchResultsDisplay results={searchResults} /> // Pass results to the new component
          ) : (
